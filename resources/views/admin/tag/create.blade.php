                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{url('admin/tag')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" required class="form-control" name="tag" id="tag" value="{{ $tag }}" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-7 col-md-offset-3">
                                    ...
                                    <button type="button" onclick="javascript:history.go(-1);" class="btn btn-primary btn-md col-md-offset-1">
