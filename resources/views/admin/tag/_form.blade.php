...
<div class="form-group">
    ...
    <div class="col-md-8">
        <input type="text" required class="form-control" name="subtitle" id="subtitle" value="{{ $subtitle }}">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <input type="text" required class="form-control" name="layout" id="layout" value="{{ $layout }}">
    </div>
</div>
