<div class="row">
    <div class="col-md-8">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="title" required autofocus id="title" value="{{ $title }}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="subtitle" required id="subtitle" value="{{ $subtitle }}">
            </div>
        </div>
        <div class="form-group">
...
//                                alert(value);
                    ...
                    <div class="col-md-4 text-right">
                        <img src="{{ asset(page_image($page_image))}}" class="img img_responsive" id="page-image-preview" style="max-height:40px">
                    </div>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea class="form-control" name="content" required rows="14" id="content">{{ $content }}</textarea>
            </div>
        </div>
    </div>
    <div class="col-md-4">
